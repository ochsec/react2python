// Transcrypt'ed from Python, 2023-03-06 12:57:03
...
export var App = function () {
	...
	return el ('form', dict ({'onSubmit': handleSubmit}), el ('label', dict ({'htmlFor': 'editBox'}), 'New Item: '), el ('input', dict ({'id': 'editBox', 'onChange': handleChange, 'value': newItem})), el ('input', dict ({'type': 'submit'})), el ('ol', null, el (ListItems, null)));
};
